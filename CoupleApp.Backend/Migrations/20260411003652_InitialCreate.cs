        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameTasks_Users_AssignedByUserId",
                        column: x => x.AssignedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameTasks_Users_AssignedToUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedTextForSender = table.Column<string>(type: "text", nullable: true),
                    IV = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameTasks_AssignedByUserId",
                table: "GameTasks",
                column: "AssignedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTasks_AssignedToUserId",
                table: "GameTasks",
